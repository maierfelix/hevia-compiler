...
export function parseOperatorDeclaration(type) {
  ...
  let node = this.createNode(Type.OperatorDeclaration);
...
export function parsePrecedenceExpression() {
  ...
  let node = this.createNode(Type.PrecedenceExpression);
...
export function parseAssociativityExpression() {
  ...
  let node = this.createNode(Type.AssociativityExpression);
